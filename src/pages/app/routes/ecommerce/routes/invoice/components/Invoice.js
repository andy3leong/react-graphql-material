      ...
      <div className="invoice-inner">
        ...
        <div className="row">
          <div className="col-8">
            ...
            <ul>
              <li>
                Aeserunt tenetur cum nihil repudiandae perferendis fuga vitae
                corporis!
              </li>
              <li>Laborum, necessitatibus recusandae ullam at iusto dolore.</li>
              <li>Voluptatum aperiam voluptates quasi!</li>
              <li>
                Assumenda, iusto, consequuntur corporis atque culpa saepe magnam
                recusandae
              </li>
          ...
          <div className="col-4 invoice-sum text-right">
            <ul className="list-unstyled">
              ...
              <li>Tax (12%): $300</li>
              <li>
                <strong>Grand Total: $ 3040</strong>
              </li>
            </ul>
          </div>
        </div>
