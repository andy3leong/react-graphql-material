...
const AvatarExampleSimple = () => (
  <List>
    ...
    <ListItem
      disabled
      leftAvatar={<Avatar icon={<i className="material-icons">camera</i>} />}
    >
      FontIcon Avatar
    </ListItem>
    <ListItem
    ...
    <ListItem disabled leftAvatar={<Avatar icon={<FileFolder />} />}>
      SvgIcon Avatar
    </ListItem>
    <ListItem
      disabled
    ...
    <ListItem disabled leftAvatar={<Avatar>A</Avatar>}>
      Letter Avatar
    </ListItem>
    <ListItem
      disabled
      leftAvatar={
        <Avatar color={deepOrange300} backgroundColor={purple500}>
          A
        </Avatar>
      }
    >
