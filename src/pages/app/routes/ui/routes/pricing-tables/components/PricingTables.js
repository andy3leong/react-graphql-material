    ...
    <div className="row">
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-primary">
          ...
          <p className="pricing-price">
            <span className="pricing-sign">$</span>0.00<span className="pricing-sub">
              /mo
            </span>
          </p>
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-success">
          ...
          <p className="pricing-price">
            <span className="pricing-sign">$</span>29.00<span className="pricing-sub">
              /mo
            </span>
          </p>
          <div className="pricing-plan-details">
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-warning">
          ...
          <p className="pricing-price">
            <span className="pricing-sign">$</span>39.00<span className="pricing-sub">
              /mo
            </span>
          </p>
          <div className="pricing-plan-details">
          ...
          <footer>
            <a href="javascript:;" className="btn btn-warning">
              Get it now
            </a>
          </footer>
        </section>
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-danger">
          ...
          <p className="pricing-price">
            <span className="pricing-sign">$</span>99.00<span className="pricing-sub">
              /mo
            </span>
          </p>
          <div className="pricing-plan-details">
