        ...
        <section className="box box-default">
          ...
          <div className="box-body">
            ...
            <div className="callout callout-info">
              <p>
                Simple Icon Menus demonstrating some of the layouts possible
                using the <code>anchorOrigin</code> and{' '}
                <code>targetOrigin</code> properties.
              </p>
            </div>
          </div>
        </section>
      ...
      <div className="col-lg-6">
        <section className="box box-default">
          ...
          <div className="box-body">
            ...
            <div className="callout callout-info">
              <p>
                The <code>maxHeight</code> property limits the height of the
                menu, above which it will be scrollable.
              </p>
            </div>
          </div>
        </section>
...
export default IconMenuSection;
