          ...
          <div className="row">
            <div className="col-xl-4">
              <p>
                ...
                Roboto for languages that use the Latin, Greek, and Cyrillic
                scripts and Noto for all other languages.
              </p>
              <p>
                <strong>Roboto</strong> has been refined extensively to work
                across the wider set of supported platforms. It is slightly
                wider and rounder, giving it greater clarity and making it more
                optimistic
              </p>
            </div>
            <div className="col-xl-8">
              <img
                src="assets/images-demo/style_typography_roboto1.png"
                alt=""
                className="img-fluid"
              />
            </div>
      ...
      <div className="box box-default">
        <div className="box-body padding-lg">
          <dl className="typo-styles">
            <dt>h1</dt>
            <dd>
              <div className="typo-styles__demo mdl-typography--display-4">
                Light 112sp
              </div>
            ...
            <dt>h2</dt>
            <dd>
              <div className="typo-styles__demo mdl-typography--display-3">
                Regular 56sp
              </div>
              <div className="typo-styles__desc">
            ...
            <dt>h3</dt>
            <dd>
              <div className="typo-styles__demo mdl-typography--display-2">
                Regular 45sp
              </div>
              <div className="typo-styles__desc">
            ...
            <dt>h4</dt>
            <dd>
              <div className="typo-styles__demo mdl-typography--display-1">
                Regular 34sp
              </div>
              <div className="typo-styles__desc">
            ...
            <dt>h5</dt>
            <dd>
              <div className="typo-styles__demo mdl-typography--headline">
                Regular 24sp
              </div>
              <div className="typo-styles__desc">
            ...
            <dt>h6</dt>
            <dd>
              <div className="typo-styles__demo mdl-typography--title">
                Regular 20sp
              </div>
              <div className="typo-styles__desc">
          ...
          <div className="box box-default">
            ...
            <div className="box-body">
              <p className="lead">
                ...
                auctor. Duis mollis, est non commodo luctus. Cum sociis natoque
      ...
      <div className="row">
        <div className="col-xl-4">
          <div className="box box-default">
            ...
            <div className="box-body">
              <ins>
                This is meant to be treated as an addition to the document.
              </ins>
            </div>
          </div>
        </div>
            ...
            <div className="box-body">
              <blockquote>
                <p>
                  ...
                  excepturi enim rerum dolore nostrum.
                </p>
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="box box-default">
            ...
            <div className="box-body">
              <p>
                <span className="dropcap">D</span>orem ipsum dolor sit amet,
                consectetur adipisicing elit. Voluptates, illo, iste itaque
                voluptas corrupti ratione reprehenderit magni similique?
                Tempore, quos delectus asperiores libero voluptas quod
                perferendis! Voluptate, quod illo rerum? Eadignissimos nobis
                facere esse neque atque quos assumenda fugiat libero.
              </p>
              <p>
                <span className="dropcap colored">D</span>orem ipsum dolor sit
                amet, consectetur adipisicing elit. Voluptates, illo, iste
                itaque voluptas corrupti ratione reprehenderit magni similique?
                Tempore, quos delectus asperiores laboriosam, dignissimos libero
                voluptas quod perferendis! Voluptate, quod illo rerum? Lorem
                ipsum dolor sit amet. Ea, ipsa in, laboriosam, dignissimos nobis
                quaerat vitae a facere esse neque .
              </p>
            </div>
          </div>
        </div>
        <div className="col-xl-6">
          <div className="box box-default">
            ...
            <div className="box-body">
              <p>
                Opsum dolor sit amet, consectetur adipisicing elit.
                Reprehenderit, quam, soluta, quia mollitia sequi voluptas magnam
                perspiciatis deleniti{' '}
                <span className="ui-highlight">ratione ad molestias eum</span>{' '}
                minima sed libero enim laborum sunt vel porro. Lorem ipsum dolor
                sit amet Eum, voluptas, placeat provident impedit<strong>
                  {' '}
                  maiores
                </strong>{' '}
                odio doloribus corrupti exercitationem veritatis ipsum ipsam
                adipisci quis consequatur assumenda rerum corporis possimus ad
                architecto
              </p>
              <p>
                Dolor sit amet, consectetur adipisicing elit. Ipsam{' '}
                <span className="ui-highlight colored">
                  consectetur adipisicing
                </span>{' '}
                elit. dolores accusantium inventore expedita ipsum quod dolore
                repellat porro laudantium necessitatibus, saepe aut ab,
                aspernatur, reprehenderit qui provident neque quibusdam
                doloremque.
              </p>
            </div>
          </div>
          ...
          <div className="box box-default">
            ...
            <div className="box-body">
              <dl className="row">
                ...
                <dd className="col-sm-9">
                  Etiam porta sem malesuada eget lacinia odio sem nec elit magna
                  mollis euismod.
                </dd>

                <dt className="col-sm-3">Felis euismod semper eget </dt>
                <dd className="col-sm-9">
                  Fusce lacinia dapibus, tellus ac cursus commodo, tortor mauris
