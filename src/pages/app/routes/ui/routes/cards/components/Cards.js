      ...
      <div className="col-xl-4">
        <Card style={{ backgroundColor: APPCONFIG.color.primary }}>
          <CardHeader
            ...
            style={{ color: '#fff' }}
          />
          <CardText expandable style={{ color: '#fff' }}>
          ...
          <CardActions expandable style={{ color: '#fff' }}>
    ...
    <div className="row">
      ...
      <div className="col-xl-4 col-lg-6">
        <div className="card bg-color-white">
          ...
          <div className="card-action">
            <a href="javascript:;">A link</a>
            <a href="javascript:;" className="color-primary">
              A link
            </a>
          </div>
        </div>
    ...
    <div className="row">
      ...
      <div className="col-xl-4">
        <div className="card card-white">
          ...
          <div className="card-content">
            <a className="card-profile-img float-right" href="javascript:;">
        ...
        <div className="card card-white">
          ...
          <div className="card-content">
            <a className="card-button float-right" href="javascript:;">
              <button className="btn btn-icon btn-icon-round btn-floating btn-danger">
                <i className="material-icons mdi-sm">favorite</i>
              </button>
            </a>
            <p>
              I am a very simple card. I am good at containing small bits of
              information. I am quite convenient because I require little markup
              to use effectively.
            </p>
          </div>
          <div className="card-action">
