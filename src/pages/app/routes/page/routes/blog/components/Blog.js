          ...
          {this.state.posts.map((post, index) => (
            <article className="blog-item" key={index}>
              ...
              <div className="blog-info">
                ...
                <span>
                  <a href="javascript:;" className="author">
                    {post.author}
                  </a>
                </span>
              ...
              <p className="desc">
                Consequuntur hic eum ab consequatur, veniam laudantium placeat
                pariatur numquam quo voluptatem velit, labore voluptas tempore
                temporibus vitae tenetur porro eligendi exercitationem fugiat
                ipsum in ullam. Necessitatibus laboriosam enim ea eos, eveniet
                corporis impedit. Lorem ipsum dolor sit amet, consectetur
                adipisicing elit.
              </p>
            </article>
          ))}
