          ...
          <div className="box box-transparent">
            <div className="box-body padding-lg-h">
              ...
              <p>
                ...
                consectetur necessitatibus ea possimus est quis cumque vel
                saepe. Eum, quas, ducimus.
              </p>
              <div className="divider divider-solid" />
              <p>
                123 Mountain View <br /> Santa Clara, C.A. <br /> USA
              </p>
              <div className="divider divider-solid" />
              <p>
          ...
          <div className="box box-transparent">
            <div className="box-body padding-lg-h">
              ...
              <form name="contactForm">
                ...
                <div className="form-group">
                  <TextField hintText="Message" fullWidth multiLine rows={3} />
                </div>
